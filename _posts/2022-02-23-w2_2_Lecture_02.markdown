...
## 2.2 Excludes one figure so that the remaining ones constitute the same pattern of relation.
...
![Is the relationship positive or negative?](https://github.com/Wario84/idsc_mgs/raw/master/assets/imgs/difference.svg?raw=true)