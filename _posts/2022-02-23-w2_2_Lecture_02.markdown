...
This framework, uses two levels, one for relations 




To understand better some specific ways in which we use inductive reasoning, let's navigate some specific examples using the framework of [Christou and Papageorgiou (2007)](https://www.sciencedirect.com/science/article/pii/S0959475206001198) for teaching inductive reasoning:
