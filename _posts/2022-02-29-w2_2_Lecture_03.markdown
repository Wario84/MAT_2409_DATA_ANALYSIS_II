...
mpg_ <- mpg
mpg_ <-
  as.data.frame(unclass(mpg_), stringsAsFactors = TRUE)    # Convert all columns to factor
...
![](https://github.com/Wario84/idsc_mgs/raw/master/assets/imgs/pie_bar_charts.svg?raw=true){width=500px}
