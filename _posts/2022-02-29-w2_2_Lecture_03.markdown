...
Another important way to understand data is by using graphical techniques or plots. I will use the `ggplot2`, that is an elegant environment to graph data using **R**. I strongly advice you to take a look a the following resources before continuing:
